    ...
    public void updateGame() {
        ...
        for(int i = 0; i < tempCollision.size(); i++) {
            ...
            if (tempCollision.get(i) instanceof ICollidableWithGameObjects) {
                Vector<GameObject> collidedGameobjects = CollidingHelper.calculateGameObjectCollisions(tempCollision.get(i), tempCollision);
            ...
            if (tempCollision.get(i) instanceof ICollidableWithTiles) {
                Vector<CollidedTile> collidedTiles = CollidingHelper.calculateTileCollision(tempCollision.get(i), tileMap);
